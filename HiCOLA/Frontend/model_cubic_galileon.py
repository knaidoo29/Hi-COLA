...
class CubicGalileon(HorndeskiModel):
    ...
    def set_cosmo_params(
            self, H0_ref, Omega_c0_ref, Omega_b0_ref, fphi,  w0=-1., wa=0., Tcmb=2.7255, Tnu0=1.9518, mnu=[], Neff=3.044):
        """
        ...
        K_G3_G4_values = [k1_Tracker, g31_Tracker]
